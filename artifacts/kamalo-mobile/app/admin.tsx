...
const styles = StyleSheet.create({
  ...
  assignment: { borderWidth: 1, borderRadius: 8, padding: 10, marginTop: 12 },
  assignmentLabel: { fontFamily: 'Inter_600SemiBold', fontSize: 9, letterSpacing: 1.1 },
  assignmentValue: { fontFamily: 'Inter_600SemiBold', fontSize: 12, marginTop: 4 },
