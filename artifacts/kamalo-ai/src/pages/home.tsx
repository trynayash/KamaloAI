               ...
               <div className="mx-auto max-w-[980px]">
                 <div className="relative rounded-xl border border-border bg-card p-1.5 shadow-[var(--shadow-md)] focus-within:border-primary/50 focus-within:ring-4 focus-within:ring-primary/5">
                    ...
                    <textarea
                      ...
                      rows={1}
                      maxLength={4000}
                       className="chat-textarea h-11 max-h-11 min-h-11 w-full resize-none overflow-hidden bg-transparent px-3 py-2 text-[14px] leading-6 outline-none placeholder:text-muted-foreground/70"
