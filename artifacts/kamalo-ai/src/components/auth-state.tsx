...
export function SignInState({ onSignIn }: { onSignIn: () => void }) {
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-background px-6">
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 text-center shadow-[var(--shadow-sm)]" role="region" aria-labelledby="sign-in-title" data-testid="state-sign-in">
        ...
        <h1 id="sign-in-title" className="mt-5 text-2xl font-extrabold tracking-[-.04em]">Sign in to continue</h1>
        <p className="mt-3 text-[13px] leading-6 text-muted-foreground">Your conversations and support requests are private to your account.</p>
